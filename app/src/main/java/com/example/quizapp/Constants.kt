...
object Constants{
    fun getQuestions():ArrayList<Question>{
        ...
        val que2 = Question(1, "What country this flag belong to?",
            R.drawable.ic_flag_of_argentina, "Argentina", "Brasil", "Armenia","Pingas",
            1)
        questionsList.add(que2)

        val que3 = Question(1, "What country this flag belong to?",
            R.drawable.ic_flag_of_belgium, "Argentina", "Brasil", "Belgium","Pingas",
            3)
        questionsList.add(que3)

        val que4 = Question(1, "What country this flag belong to?",
